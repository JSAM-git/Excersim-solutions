...
def preparation_time_in_minutes (number_of_layers):
    """Calculate the preparation time in minutes.
        ...
        Returns:
            int: The preparation time (in minutes) derived from 'preparation_time_layers'.
    ...
    """
    preparation_time_layers = PREPARATION_TIME * number_of_layers
    return preparation_time_layers
...
def elapsed_time_in_minutes(number_of_layers, elapsed_bake_time):
    """Calculate the bake time remaining.
        ...
        Returns:
            int: The elapsed time (in minutes) derived from 'elapsed_time'.

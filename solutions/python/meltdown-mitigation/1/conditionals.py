...
def fail_safe(temperature, neutrons_produced_per_second, threshold):
    ...
    """
    percent_treshold = threshold / 10
    if (temperature * neutrons_produced_per_second) < (threshold - percent_treshold):
        return 'LOW'
    elif (temperature * neutrons_produced_per_second) >= (threshold - percent_treshold) and (temperature * neutrons_produced_per_second) <= (threshold + percent_treshold):
        return 'NORMAL'
    else:
        return 'DANGER'
